---
name: whose-turn-ui-style
description: Generate or implement UI in the Whose Turn? visual style — a playful neo-brutalist retro chore-lottery app for couples and families. Use when creating screens, components, mockups, or code that should match this design: warm cream #fff9ee canvas, thick dark-brown #332014 outlines (2–3px), hard offset shadows with zero blur (4px/2px 0 #332014), Corben Bold slab-serif headlines, DM Sans body, terracotta #d85a38 primary CTAs, yellow #e8a838 chosen state, full-pill buttons, 24px cards, and the fortune wheel plus hand-drawn confetti. Triggers include "Whose Turn style", neo-brutalist retro UI, or keeping new task-app screens on-brand with it.
---

# Whose Turn? — Neo-Brutalist Retro UI Style

Use this skill to generate or implement new UI in the same visual style as the **Whose Turn?** chore-lottery app — in Figma Make, Claude Code, Codex, Cursor, Lovable, Replit, or any AI builder. The goal: a new screen, component, or flow that feels like it belongs to this exact product.

## How to use this skill

1. Read **Style DNA Summary** and **Signature Style Elements** first — those are the non-negotiables.
2. Pull concrete values from **Visual Foundations** (colors, type, spacing, radius, borders, shadows).
3. Build from **Component Style Rules** and **Layout System**.
4. Before finishing, check against **Style Loss Risks** and **Do / Don't Style Rules**.
5. Respect the **Evidence Map**: never present Inferred/Suggested items as confirmed facts, and don't invent values marked Unresolved.
